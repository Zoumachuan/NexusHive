...
watch(activeShipLanes, (newVal: string) => {
    if (newVal) {
        ...
        // // 视角飞过去
        // marsMap.value.setCameraView({
        //     lat: shipStartPoint.value[0][1],
        //     lng: shipStartPoint.value[0][0],
        //     alt: 2200,
        //     heading: 360,
        //     pitch: -54,
        // })

        // marsMap.value.flyToPoint([shipStartPoint.value[0][0], shipStartPoint.value[0][1], shipStartPoint.value[0][2]])
