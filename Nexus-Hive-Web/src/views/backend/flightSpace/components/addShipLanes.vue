        ...
        <div class="content">
            ...
            <div class="content-item">
                ...
                <el-radio-group v-model="form.flightModel" style="width: 100%">
                    <div class="content-item-content">
                        <div class="content-item-content-box" :class="{ active: form.flightModel === '1' }" v-if="form.flightType === '1'">
                            <el-radio id="radio" value="1" size="large" style="width: 100%; height: 100%">M3D</el-radio>
                        </div>
                        <div class="content-item-content-box" :class="{ active: form.flightModel === '2' }" v-if="form.flightType === '1'">
                            <el-radio id="radio" value="2" size="large" style="width: 100%; height: 100%">M3TD</el-radio>
                        </div>
                        <div class="content-item-content-box" :class="{ active: form.flightModel === '1' }" v-if="form.flightType === '2'">
                            <el-radio id="radio" value="1" size="large" style="width: 100%; height: 100%">M4D</el-radio>
                        </div>
                        <div class="content-item-content-box" :class="{ active: form.flightModel === '2' }" v-if="form.flightType === '2'">
                            <el-radio id="radio" value="2" size="large" style="width: 100%; height: 100%">M4TD</el-radio>
                        </div>
                    </div>
                </el-radio-group>
            </div>
