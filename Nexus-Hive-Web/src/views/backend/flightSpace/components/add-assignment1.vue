                ...
                <div class="content-item">
                    ...
                    <el-form-item label="任务类型" prop="task_type" class="flex-1">
                        <div class="content-item-content1">
                            <div class="content-item-tab" :class="{ active: form.task_type === 0 }" @click="form.task_type = 0">立即执行</div>
                            <div class="content-item-tab" :class="{ active: form.task_type === 1 }" @click="form.task_type = 1">定时执行</div>
                        </div>
                    </el-form-item>
                </div>
                <!-- 开始执行时间 -->
