<template>
    <div class="video-player-container" ref="videoPlayerContainer" v-if="isShowCabinLive" v-draggable="{ isFullScreen }">
        <div class="video-player-content">
            ...
            <div class="video-overlay" v-if="mediaStore.video_type === 1">
...
const startRtmpLive = async () => {
    await DJIoperations.sendServices(disposition.djiDock.gateway_sn, 'live_start_push', disposition.getDjiDockRtmpData())
    rtmpLiveRef.value?.play()
}
