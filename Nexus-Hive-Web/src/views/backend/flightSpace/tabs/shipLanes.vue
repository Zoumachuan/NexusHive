                ...
                <el-collapse-item :name="index" v-for="(item, index) in shipLanesFolderList" :key="index">
                    ...
                    <div class="shipLanes-content">
                        ...
                        >
                            ...
                            <!-- 跳转虚拟座舱 -->
                            <!-- <el-tooltip class="box-item" effect="dark" content="前往虚拟座舱" placement="top">
                                <img class="item-box-image1" src="/img/cokpit/icon24.png" alt="" @click="handleJump(item1)" />
                            </el-tooltip> -->
                        </div>
...
const handleRename = (item: any) => {
    ElMessageBox.prompt('航线名称', '编辑航线名称', {
        ...
        // await new baTableApi('/admin/airline.Floder/').editPost(item)
        if (res.code == 1) {
            item.name = value
            ElMessage.success('重命名成功')
        }
