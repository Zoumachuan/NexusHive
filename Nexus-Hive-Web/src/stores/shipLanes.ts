        ...
        addPlacemark(coordinates: string, isStartPoint: boolean, alt: number) {
            if (isStartPoint) {
                ...
                if (this.shipForm.Folder.waylineCoordinateSysParam.heightMode === 'EGM96') {
                    ...
                    placemark.executeHeight = this.shipForm.Folder.globalHeight + this.mqttStore.deviceData.height
                }
                // 当前航点
        ...
        async savePlacemark() {
            ...
            this.shipForm.Folder.Placemark.forEach((item) => {
                if (this.shipForm.Folder.waylineCoordinateSysParam.heightMode === 'EGM96') {
                    ...
                    item.executeHeight = this.shipForm.Folder.globalHeight + this.mqttStore.deviceData.height
                }
            })
